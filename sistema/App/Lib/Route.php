...
abstract class Route {
	...
	private static $header2;
	private static $pageLoad='html/home.php';
    private static $title = 'Executive Search Marketplace';
	private static $showNavleft = true;
	private static $showNavContentRight = true;
	...
	public static function setPageHeader2($value){
		if(!empty($value))
			array_push(self::$header2,$value);
	}
